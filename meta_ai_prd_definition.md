...
The Meta-PRD defines the **governing rules and index of phases**. Each phase PRD defines a **scoped build step with placeholders and contracts for handoff**. Together, they:
